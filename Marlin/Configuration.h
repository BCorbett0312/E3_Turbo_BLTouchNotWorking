...
#define STRING_CONFIG_H_AUTHOR "ToxicElitist, BTTv1.1)" // Who made the changes.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_FEEDRATE    510  // (mm/s) Z axis feedrate (not used for delta printers)
#endif
